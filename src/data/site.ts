...
export const siteConfig = {
  name: "Real PM Jobs",
  description:
    "Real PM Jobs filters for product roles with real outcome ownership, decision rights, and discovery capacity.",
  thesis:
    "If a role does not own outcomes, decision rights, and discovery capacity, it is not a real PM job.",
